...
var s_account="channel4dotcomtest";
if(document.location.hostname.indexOf("channel4.com")!=-1){
      s_account="channel4dotcom";
}
...
s.linkInternalFilters="javascript:,.channel4.com"
s.linkLeaveQueryString=false
s.linkTrackVars="None"
s.linkTrackEvents="None"
/* Timeparting Config Variables */
s.dstStart="03/30/"+new Date().getFullYear();
s.dstEnd="10/26/"+new Date().getFullYear();
s.currentYear=+new Date().getFullYear();
/* Plugin Config */
s.usePlugins=true
function s_doPlugins(s) {
if (!s.pageName) { s.pageName="embarassingbodies:riskchecker" + location.pathname; }
// Copy prop 1,2,3 into evar1,2,3 if set
if (!s.prop1) {s.prop1="channel4";}
if (s.prop1) {s.eVar1 = s.prop1;}
if (!s.prop2) { s.prop2=s.eVar2="Life"; }
if (s.prop2) { s.eVar2=s.prop2; }
if (!s.prop3) { s.prop3=s.eVar3="external microsite"; }
if (!s.prop4) { s.prop4=s.eVar4="embarassingbodies:riskchecker"; }
if (!s.prop12) { s.prop12 = s.getPreviousValue(s.pageName, "gpv_p12", ""); }
// set campaign tracking code
s.campaign = s.getValOnce(s.getQueryParam('cntsrc'),'s_c4so45_cmp',0);
if (s.campaign) {
...
if (s.prop14) { s.eVar59=s.prop14; }
// Capture page URL
  if (!s.prop18) { s.prop18=location.protocol + "//" + location.host + location.pathname; }
  if (s.prop18)  { s.eVar18=s.prop18; }
// Day of the Week | Hour of Day
s.prop25 =  s.getTimeParting('d','+0') + " | " + s.getTimeParting('h','+0');
if (s.prop25) { s.eVar25 = s.prop25; }
if (s.events) { s.events=s.prop26; }
if (s.prop26) {s.prop26=s.eVar26; }
if(!s.prop27) {s.prop27 = document.title; }
if(s.prop27) { s.eVar27 = s.prop27; }
//Authentication state and GUID into eVar
if (s.prop34) { s.eVar34=s.prop34; }
s.prop45="D=s_vi" // captures the s_vi (visitor ID) cookie value
if (s.prop45) { s.eVar45 = s.prop45; }
// set s.prop7 if user is repeat
s.prop57=s.getNewRepeat();
//Hierachy
s.hier1=s.prop1 + "|" + s.prop2 + "|" + s.pageName;
}
...
s.trackingServerSecure = "webstats.channel4.com";
s.dc=112;
...
+"epa(v)}return ''");
/* Plugin: getNewRepeat - returns whether a user is new or repeat.
 Sets it for 30 days from the first day the user came to the site.  */
